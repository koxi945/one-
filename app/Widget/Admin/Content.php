...
class Content extends AbstractBase
{
    ...
    {
        $this->setCurrentAction('content', 'edit')->setData($data)->checkPermission();
    ...
    {
        $this->setCurrentAction('content', 'delete')->setData($data)->checkPermission();
        $url = route('common', ['class' => $this->class, 'action' => $this->function, 'id' => $data['id']]);
        $html = $this->hasPermission ?
    ...
    {
        $this->setCurrentAction('content', 'add')->checkPermission();
