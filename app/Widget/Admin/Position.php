...
class Position extends AbstractBase
{
    ...
    {
        $this->setCurrentAction('position', 'edit')->setData($data)->checkPermission();
    ...
    {
        $this->setCurrentAction('position', 'delete')->setData($data)->checkPermission();
        $url = route('common', ['class' => $this->class, 'action' => $this->function, 'id' => $data['id']]);
        $html = $this->hasPermission ?
    ...
    {
        $this->setCurrentAction('position', 'add')->checkPermission();
