...
class User extends AbstractBase
{
    ...
    {
        $this->setCurrentAction('user', 'edit')->setData($data)->checkPermission(Acl::GROUP_LEVEL_TYPE_USER);
    ...
    {
        $this->setCurrentAction('user', 'delete')->setData($data)->checkPermission(Acl::GROUP_LEVEL_TYPE_USER);
        $url = route('common', ['class' => $this->class, 'action' => $this->function, 'id' => $data['id']]);
        $html = $this->hasPermission ?
    ...
    {
        $this->setCurrentAction('acl', 'user')->setData($data)->checkPermission(Acl::GROUP_LEVEL_TYPE_USER);
        $url = route('common', ['class' => $this->class, 'action' => $this->function, 'id' => $data['id']]);
        $html = $this->hasPermission ?
    ...
    {
        $this->setCurrentAction('user', 'add')->checkPermission(Acl::GROUP_LEVEL_TYPE_USER);
